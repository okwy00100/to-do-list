package com.okwy.todolist.Views.Adapters;
...
import com.okwy.todolist.Entity.Note;
import com.okwy.todolist.R;
...
public class NoteAdapter extends ListAdapter<Note, NoteAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.note_list_item, parent, false));
    }
